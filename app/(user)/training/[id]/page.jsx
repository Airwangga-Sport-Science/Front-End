			...
			<div className="flex md:flex-row flex-col">
				...
				<div className="flex flex-col bg-white shadow-xl rounded-xl px-6 py-6 w-full">
					<div className="flex justify-between">
						...
						{isComplete == false ? (
							<button
								className="bg-blue-500 text-white h-12 px-6 rounded-xl font-semibold text md:block hidden"
								onClick={() => handleComplete()}
							>
								Selesaikan
							</button>
						) : (
							<button className="bg-slate-100 text-slate-500 h-12 px-6 rounded-xl font-semibold text">
								Selesai
							</button>
						)}
					</div>
					...
					<p>{article?.body}</p>
					<h4 className="text-lg font-semibold mt-4">Training Instruction</h4>
					...
					{isComplete == false ? (
						<button
							className="bg-blue-500 text-white h-12 px-6 rounded-xl font-semibold text md:hidden block"
							onClick={() => handleComplete()}
						>
							Selesaikan
						</button>
